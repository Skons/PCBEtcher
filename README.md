...
You can generate two kinds of model:

- **PCB**: the PCB itself, with recessed or raised traces and pads.
- **Etcher**: an etch template that fits around the PCB.

## Quick start

1. Open `PCBEtcher.html` in your browser.
